    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{{ Route('admin.product.index') }}">Category</a></li>
        ...
        <div class="card card-primary">
          ...
          <form action="{{ Route('admin.category.update', $category->id) }}" method="post" class="card-body">
            ...
            <div class="form-group">
              ...
              <textarea rows="4" cols="50" type="text" id="desc" name="description" class="form-control" >{{$category->description}}</textarea>
            </div>          
